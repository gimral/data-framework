...
public class JsonGenericAvroSerde implements Serde<GenericRecord> {

    private final Serde<GenericRecord> inner;

    public JsonGenericAvroSerde() {
        inner = Serdes.serdeFrom(new JsonToGenericAvroSerializer(), new GenericAvroToJsonDeserializer());
    }
