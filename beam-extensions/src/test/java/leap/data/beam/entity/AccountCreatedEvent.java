...
public class AccountCreatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public AccountCreatedEvent(Long eventId, Long traceId, CharSequence type, Account data) {
  ...
  public void put(int field$, Object value$) {
    ...
    case 3: data = (Account)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * @return A new AccountCreatedEvent RecordBuilder
   */
  public static Builder newBuilder(AccountCreatedEvent other) {
    if (other == null) {
      return new Builder();
    } else {
      return new Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AccountCreatedEvent>
    ...
    private CharSequence type;
    private Account data;
    private Account.Builder dataBuilder;
    ...
    private Builder(Builder other) {
      ...
      if (other.hasDataBuilder()) {
        this.dataBuilder = Account.newBuilder(other.getDataBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(AccountCreatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public Builder setData(Account value) {
     ...
     * @return This builder.
     */
    public Account.Builder getDataBuilder() {
      if (dataBuilder == null) {
        if (hasData()) {
          setDataBuilder(Account.newBuilder(data));
        } else {
          setDataBuilder(Account.newBuilder());
        }
      }
      return dataBuilder;
    }
     ...
     * @return This builder.
     */
    public Builder setDataBuilder(Account.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    public AccountCreatedEvent build() {
      try {
        ...
        if (dataBuilder != null) {
          ...
          record.data = fieldSetFlags()[3] ? this.data : (Account) defaultValue(fields()[3]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
