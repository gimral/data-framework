 ...
 * @see Decoder
 */
public class JsonValidatingDecoder extends ParsingDecoder
        implements Parser.ActionHandler {
    protected Decoder in;

    JsonValidatingDecoder(Symbol root, Decoder in) throws IOException {
        super(root);
        this.configure(in);
    }

    JsonValidatingDecoder(Schema schema, Decoder in) throws IOException {
    ...
    public JsonValidatingDecoder configure(Decoder in) throws IOException {
        this.parser.reset();
        this.in = in;
        return this;
    }
