 ...
 */
public class JsonResolvingDecoder extends JsonValidatingDecoder {

    private Decoder backup;

    JsonResolvingDecoder(Schema writer, Schema reader, Decoder in)
            throws IOException {
     ...
     * The resolver must have been returned by a previous call todatingDecoder
     * {@link #resolve(Schema, Schema)}.
     * @param resolver  The resolver to use.
     * @param in  The underlying decoder.
     * @throws IOException
     */
    private JsonResolvingDecoder(Object resolver, Decoder in)
            throws IOException {
     ...
     *
     * This method is useful because {@link JsonResolvingDecoder}
     ...
     *     }
     * </pre>
     * Note that {@link JsonResolvingDecoder} will return only the
    ...
    public int readEpoch() throws IOException {
        ...
        assert actual == Symbol.INT;
        return ((ExtendedJsonDecoder)in).readEpoch();
