...
public class AccountBalanceUpdatedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static AccountBalanceUpdatedEvent fromByteBuffer(
   ...
   private leap.data.beam.entity.AccountBalance data;
   ...
   */
  public AccountBalanceUpdatedEvent(java.lang.Long eventId, java.lang.Long traceId, java.lang.CharSequence type, leap.data.beam.entity.AccountBalance data) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: data = (leap.data.beam.entity.AccountBalance)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public leap.data.beam.entity.AccountBalance getData() {
    return data;
  }
   ...
   * @param value the value to set.
   */
  public void setData(leap.data.beam.entity.AccountBalance value) {
    this.data = value;
  }
   ...
   */
  public static leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder newBuilder() {
    return new leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder();
  }
   ...
   * @return A new AccountBalanceUpdatedEvent RecordBuilder
   */
  public static leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder newBuilder(leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder other) {
    if (other == null) {
      return new leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder();
    } else {
      return new leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder(other);
    }
  }
   ...
   * @return A new AccountBalanceUpdatedEvent RecordBuilder
   */
  public static leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder newBuilder(leap.data.beam.entity.AccountBalanceUpdatedEvent other) {
    if (other == null) {
      return new leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder();
    } else {
      return new leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AccountBalanceUpdatedEvent>
    ...
    private java.lang.CharSequence type;
    private leap.data.beam.entity.AccountBalance data;
    private leap.data.beam.entity.AccountBalance.Builder dataBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder other) {
      super(other);
      ...
      if (other.hasDataBuilder()) {
        this.dataBuilder = leap.data.beam.entity.AccountBalance.newBuilder(other.getDataBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(leap.data.beam.entity.AccountBalanceUpdatedEvent other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.eventId)) {
        this.eventId = data().deepCopy(fields()[0].schema(), other.eventId);
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder setEventId(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder clearEventId() {
      eventId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder setTraceId(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder clearTraceId() {
      traceId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder setType(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder setData(leap.data.beam.entity.AccountBalance value) {
     ...
     * @return This builder.
     */
    public leap.data.beam.entity.AccountBalance.Builder getDataBuilder() {
      if (dataBuilder == null) {
        if (hasData()) {
          setDataBuilder(leap.data.beam.entity.AccountBalance.newBuilder(data));
        } else {
          setDataBuilder(leap.data.beam.entity.AccountBalance.newBuilder());
        }
      }
      return dataBuilder;
    }
     ...
     * @return This builder.
     */
    public leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder setDataBuilder(leap.data.beam.entity.AccountBalance.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalanceUpdatedEvent.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public AccountBalanceUpdatedEvent build() {
      try {
        ...
        if (dataBuilder != null) {
          ...
          record.data = fieldSetFlags()[3] ? this.data : (leap.data.beam.entity.AccountBalance) defaultValue(fields()[3]);
        }
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      if (this.data == null) {
        this.data = new leap.data.beam.entity.AccountBalance();
      }
