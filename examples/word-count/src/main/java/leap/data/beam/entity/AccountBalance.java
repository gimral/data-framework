...
public class AccountBalance extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static AccountBalance fromByteBuffer(
   ...
   private java.lang.Double previous_balance;
   ...
   */
  public AccountBalance(java.lang.Long acid, java.lang.Double previous_balance, java.lang.Double balance) {
    this.acid = acid;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: acid = (java.lang.Long)value$; break;
    case 1: previous_balance = (java.lang.Double)value$; break;
   ...
   */
  public java.lang.Double getPreviousBalance() {
   ...
   * @param value the value to set.
   */
  public void setPreviousBalance(java.lang.Double value) {
   ...
   */
  public static leap.data.beam.entity.AccountBalance.Builder newBuilder() {
    return new leap.data.beam.entity.AccountBalance.Builder();
  }
   ...
   * @return A new AccountBalance RecordBuilder
   */
  public static leap.data.beam.entity.AccountBalance.Builder newBuilder(leap.data.beam.entity.AccountBalance.Builder other) {
    if (other == null) {
      return new leap.data.beam.entity.AccountBalance.Builder();
    } else {
      return new leap.data.beam.entity.AccountBalance.Builder(other);
    }
  }
   ...
   * @return A new AccountBalance RecordBuilder
   */
  public static leap.data.beam.entity.AccountBalance.Builder newBuilder(leap.data.beam.entity.AccountBalance other) {
    if (other == null) {
      return new leap.data.beam.entity.AccountBalance.Builder();
    } else {
      return new leap.data.beam.entity.AccountBalance.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AccountBalance>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(leap.data.beam.entity.AccountBalance.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(leap.data.beam.entity.AccountBalance other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.acid)) {
        this.acid = data().deepCopy(fields()[0].schema(), other.acid);
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalance.Builder setAcid(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalance.Builder clearAcid() {
      acid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalance.Builder setPreviousBalance(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalance.Builder clearPreviousBalance() {
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalance.Builder setBalance(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.AccountBalance.Builder clearBalance() {
      balance = null;
    ...
    public AccountBalance build() {
      try {
        ...
        record.acid = fieldSetFlags()[0] ? this.acid : (java.lang.Long) defaultValue(fields()[0]);
        record.previous_balance = fieldSetFlags()[1] ? this.previous_balance : (java.lang.Double) defaultValue(fields()[1]);
