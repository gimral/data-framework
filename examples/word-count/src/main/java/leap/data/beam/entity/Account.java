...
public class Account extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Account(java.lang.Long acid, java.lang.Double balance) {
    this.acid = acid;
   ...
   */
  public static leap.data.beam.entity.Account.Builder newBuilder() {
    return new leap.data.beam.entity.Account.Builder();
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static leap.data.beam.entity.Account.Builder newBuilder(leap.data.beam.entity.Account.Builder other) {
    if (other == null) {
      return new leap.data.beam.entity.Account.Builder();
    } else {
      return new leap.data.beam.entity.Account.Builder(other);
    }
  }
   ...
   * @return A new Account RecordBuilder
   */
  public static leap.data.beam.entity.Account.Builder newBuilder(leap.data.beam.entity.Account other) {
    if (other == null) {
      return new leap.data.beam.entity.Account.Builder();
    } else {
      return new leap.data.beam.entity.Account.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Account>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(leap.data.beam.entity.Account.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(leap.data.beam.entity.Account other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.acid)) {
        this.acid = data().deepCopy(fields()[0].schema(), other.acid);
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.Account.Builder setAcid(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.Account.Builder clearAcid() {
      acid = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.Account.Builder setBalance(java.lang.Double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public leap.data.beam.entity.Account.Builder clearBalance() {
      balance = null;
